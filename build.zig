...
pub fn build(b: *Builder) !void {
    ...
    const elf = b.addSystemCommand(&.{ devkitpro ++ "/devkitPPC/bin/powerpc-eabi-gcc", "build/main.o", "-g", "-DGEKKO", "-mrvl", "-mcpu=750", "-meabi", "-mhard-float", "-Wl,-Map,build/.map", "-L" ++ devkitpro ++ "/libogc/lib/wii", "-L" ++ devkitpro ++ "/portlibs/ppc/lib", "-lmad", "-lasnd", "-logc", "-o", "build/" ++ name ++ ".elf" });
